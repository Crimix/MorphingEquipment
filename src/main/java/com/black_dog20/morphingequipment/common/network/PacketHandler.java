package com.black_dog20.morphingequipment.common.network;
...
public class PacketHandler {
    ...
    public static final SimpleChannel NETWORK = NetworkRegistry.ChannelBuilder
            .named(new ResourceLocation(MorphingEquipment.MOD_ID, "network"))
    ...
    public static void register() {
        registerMessage(PacketSwitchMorph.class, PacketSwitchMorph::encode, PacketSwitchMorph::decode, PacketSwitchMorph.Handler::handle);
    }
